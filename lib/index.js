...
Engine.prototype.getStrategies = function( name ){
  return this._strategies;
}

Engine.prototype.showStrategies = function(){

  var strategies = Object.keys( this._strategies );

  console.log('Strategies: ' + strategies.length );
  for( var s in strategies ){
    console.log( strategies[s] );
  }
  console.log('==========');

}

Engine.prototype.process = function( strategyName, modelName ){
  ...
  if( this._models[modelName] === undefined ){
	...
	return this._strategies[strategyName].process( this._models[modelName] );
}
